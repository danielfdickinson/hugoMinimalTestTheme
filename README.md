...
For the parts of styles that apply to the debug tables, see [hugoDebugTables README.md](https://gihub.com/danielfdickinson/hugoDebugTables/blog/master/README.md)
